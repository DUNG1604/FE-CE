            ...
            <nav id="navbar" class="navbar">
              <ul>
                ...
                <li class="dropdown">
                  ...
                  <ul>
                    <li>
                      <a href="/#mission" onClick={clickMobieHideNavb}>
                        Sứ mệnh
                      </a>
                    </li>
                    <li>
                      <a href="/#vision" onClick={clickMobieHideNavb}>
                        Tầm nhìn
                      </a>
                    </li>
                    <li>
                      <a href="/#our-value" onClick={clickMobieHideNavb}>
                        Giá trị cốt lõi
                      </a>
                    </li>
                    <li>
                      <a href="/#philosophy" onClick={clickMobieHideNavb}>
                        Triết lý thương hiệu
                      </a>
                    </li>
                    <li>
                      <a href="/#human-resource" onClick={clickMobieHideNavb}>
                        Con người
                      </a>
                    </li>
                  </ul>
