          ...
          <div className="row gx-lg-0 gy-4">
              ...
              <div className="info-container d-flex flex-column">
                <div className="content">
                  <p className="sub-title">
                    Dự án “Mùa hè không hối tiếc” là dự án dành riêng cho các
                    bạn sinh viên trường Đại học Kinh tế Quốc dân do
                    CareerEmpower tổ chức, nhằm giúp bạn khám phá năng lực cũng
                    như định vị bản thân trong thị trường lao động hiện nay. Khi
                    tham gia CareerEmpower, bạn còn nhận được những lợi ích sau:
                  </p>
                  <ul>
                    <li>
                    ...
                    <li>
                      <i class="ri-check-double-line"></i>
                      Tạo dựng thương hiệu cùng với các bạn sinh viên NEU trên
                      các kênh truyền thông xã hội có hơn 100k thành viên của
                      CareerEmpower.
                    </li>
                    <li>
                      <i class="ri-check-double-line"></i>
                      Được cấp chứng nhận khi tham gia và hoàn thành các dự án
                      thực tế của CareerEmpower cùng mạng lưới các nhà tuyển
                      dụng, doanh nghiệp hàng đầu trong nhiều lĩnh vực như FPT,
                      VNG, Vinhomes…
                    </li>
                    <li>
                      <i class="ri-check-double-line"></i>
                    ...
                    <li>
                      <i class="ri-check-double-line"></i>
                      Thực tập làm việc trong môi trong chuyên nghiệp, năng
                      động, sáng tạo đa dạng về nhiều lĩnh vực.
                    </li>
                  </ul>
                  <div className="btn-details">
                    <a
                      href="https://drive.google.com/drive/folders/1mKu0yp6oYAr0uocKpHlmBGHm4ukTpa96"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="button form-group mt-1 "
                    >
                      <button type="details">
            ...
            <div className="col-lg-6">
              <form
                ...
                action=""
                className="ungtuyen-form text-center"
              >
